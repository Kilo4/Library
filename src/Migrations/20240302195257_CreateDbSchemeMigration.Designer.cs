...
namespace Webapi.Migrations
{
    ...
    [Migration("20240302195257_CreateDbSchemeMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Webapi.Models.Site", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Webapi.Models.Article", b =>
                {
                    b.HasOne("Webapi.Models.Site", "Site")
                        .WithMany()
            ...
            modelBuilder.Entity("Webapi.Models.Image", b =>
                {
                    b.HasOne("Webapi.Models.Author", null)
                        .WithOne("Image")
                        .HasForeignKey("Webapi.Models.Image", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
